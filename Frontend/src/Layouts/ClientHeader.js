            ...
            <div className="container-fluid sticky-top px-0">
                ...
                <div className="container px-0">
                    <nav className="navbar navbar-expand-lg navbar-dark bg-white py-3 px-4">
                        <Link to="/Client" className="navbar-brand p-0">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav ms-auto py-0">
                                ...
                                {/* <Link to="/Client/AllBDE" className="nav-item nav-link">
                                    BDEs
                                </Link> */}
                                <div className="nav-item dropdown">
                                    ...
                                    <div className="dropdown-menu m-0">
                                        <Link to="/Client/AddProject" className="dropdown-item">
                                            Add Project
                                        </Link>
                                        <Link to="/Client/ViewAllProject" className="dropdown-item">
                                            Manage Project
                                        </Link>
                                    </div>
                                </div>
                                <Link to="/Client/ViewAllBid" className="nav-item nav-link">
                                    Bid
                                </Link>

                                {/* <Link to="/Client/Contact" className="nav-item nav-link">
                                    Contact
                                </Link> */}
