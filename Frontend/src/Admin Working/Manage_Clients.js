...
export default function Manage_Clients() {
    ...
    const changeStatusFalse = (_id) => {
        if (window.confirm("Are you sure to Change the Status??")) {
            ...
            setLoad(true);
            ApiServices.clientChangeStatus(data)
                .then((res) => {
                    console.log(res);
                    if (res.data.success) {
                                        ...
                                        <tbody>
                                            {
                                                clientData?.map((el, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <Link className="btn btn-primary" to={"/Admin/ClientProjects/" + el._id} style={{ backgroundColor: "blue" }}>
                                                                Client's Project <i className="fa fa-eye"></i>
                                                            </Link>
                                                        </td>
                                                        <td>
